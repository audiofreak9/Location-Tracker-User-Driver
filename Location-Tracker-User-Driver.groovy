...
metadata {
  definition (name: "Location Tracker User Driver", namespace: "BPTWorld", author: "Bryan Turcotte", importUrl: "https://raw.githubusercontent.com/bptworld/Hubitat/master/Ported/Life360/L-driver.groovy") {
        ...
        // ***** Capabilities to support MurnControl *****
        capability "Lock"
        // MurnControl capabilities end
        ...
        // ***** Attributes to support capabilities added above for MurnControl *****
        attribute "MURN-statusTile1", "string"
        attribute "lock", "string"
        // MurnControl attributes end
